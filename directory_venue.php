<?php
// Directory_Venue.php — Venue category page (matches User_Homepage/Directory styles)
...
<head>
  ...
  <title>Venue Directory — Everest</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* ===== HERO (large, scrollable) ===== */
    /* Keep these rules last within the block so they win */
    #venue-hero{
      height:70vh;                  /* page can scroll */
      min-height:520px;             /* desktop floor */
      position:relative;
      background:url('venuebackground.png') center 55% / cover no-repeat; /* replace with your path if needed */
    ...
    .card{ background:var(--card-soft); border:1px solid #cfe0ff; border-radius:12px; overflow:hidden; box-shadow:0 8px 22px rgba(31,41,55,.06); min-height:180px }
    .card img{ display:block; width:100%; height:170px; object-fit:cover }
    .card-body{ padding:14px 16px 18px }
    .card h3{ margin:4px 0 10px; font-size:16px; font-weight:800; letter-spacing:.2px; color:var(--ink) }
    .meta{ color:#334155; font-size:12px; line-height:1.6 }
    .price{ margin-top:8px; font-weight:700; color:#0f172a; font-size:13px }
    ...
    @media (max-width:980px){
      ...
      #venue-hero{height:56vh; min-height:380px}
      #venue-hero .hero-title{left:28px; bottom:40px}
...
<body>
    ...
    <div class="right-actions">
      ...
      <div class="account">
        <button class="toplink account-toggle" type="button" aria-haspopup="menu" aria-expanded="false">
          ...
          <svg class="caret" viewBox="0 0 24 24" aria-hidden="true"><path d="M7 9l5 5 5-5" stroke="currentColor" stroke-width="2" fill="none" stroke-linecap="round" stroke-linejoin="round"/></svg>
        </button>
  ...
  <!-- HERO -->
  <!-- Put your own banner file as venuepic.jpg (same folder) or change the CSS background URL above -->
  <section id="venue-hero" aria-label="Elegant wedding venue with chandeliers">
  ...
  <main class="wrap">
    <div class="grid">
      <!-- Card 1 -->
	<a href="Venue_Detail.php?id=hyatt" style="text-decoration:none;color:inherit;">
		<article class="card">
			<img src="venue_hyatt.jpg" alt="Hyatt Regency Maui Resort">
			<div class="card-body">
				<h3>Hyatt Regency Maui Resort</h3>
				<div class="meta">59 Doña Carmen Avenue, Quezon City</div>
      ...
      <!-- Card 2 -->
    <a href="Venue_Detail.php?id=kauai" style="text-decoration:none; color:inherit;">
		<article class="card">
			<img src="venue_kauai.jpg" alt="Kaua'i Wedding Venue" />
			<div class="card-body">
				<h3>Kaua'i Wedding Venue</h3>
				<div class="meta">0 B-10 Katipunan Ave. Ext., White Plains, Quezon City, Metro Manila</div>
      ...
      <!-- Card 3 -->
    <a href="Venue_Detail.php?id=alexandrite" style="text-decoration:none; color:inherit;">
		<article class="card">
			<img src="venue_alexandrite.jpg" alt="The Alexandrite Resort">
			<div class="card-body">
				<h3>The Alexandrite Resort</h3>
				<div class="meta">77 Timog Ave, Diliman, Quezon City, 1103 Metro Manila</div>
      ...
      <!-- Card 4 -->
	<a href="Venue_Detail.php?id=golden" style="text-decoration:none; color:inherit;">
		<article class="card">
			<img src="venue_goldenpalace.jpg" alt="The Golden Palace">
			<div class="card-body">
				<h3>The Golden Palace</h3>
				<div class="meta">66 Esteban Abada St., Loyola Heights, Quezon City, 1108 Metro Manila</div>
				<div class="price">₱100,000</div>
			</div>
		</article>
	</a>
