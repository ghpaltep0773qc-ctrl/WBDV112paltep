<?php
// Directory_PhotosVideos.php — Photos & Videos category page
...
<head>
  ...
  <title>Photos &amp; Videos — Everest</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    #pv-hero{
	  ...
	  min-height:520px;
	  position:relative;
	  background:url('photosvideosbg.jpg') center 55% / cover no-repeat;
	  /* use the same file as Directory_Venue; change name if needed */
	  background-color:#c7c2bb;     /* fallback color */
	}
    ...
    @media (max-width:980px){
      ...
      .pv-grid{grid-template-columns:1fr; justify-items:stretch}
      .pv-package{max-width:none}
      #pv-hero{height:260px}
    }
  </style>
</head>
<body>
...
<!-- HERO -->
<section id="pv-hero" aria-label="Photos and Videos hero">
  <h1 class="hero-title">PHOTOS AND VIDEOS</h1>
</section>

<main class="wrap">
  <p class="pv-intro">
    Capture every laugh, tear, and dance step with Everest’s curated photo and video packages.
    Choose the coverage that fits your celebration and keep your wedding memories alive for years.
  </p>

  <div class="pv-grid">
    <!-- GLEE PACKAGE -->
    <section class="pv-package">
      <div class="pv-photo">
        <img src="pvwedding.jpg" alt="GLEE photo and video package sample">
      </div>
      <article class="pv-card">
        <div class="pv-title">GLEE Package</div>
        <div class="pv-price">Php 20,000</div>
        <ul class="pv-list">
          <li>Full Photo Coverage (2 Photographers)</li>
          <li>1 Professional Videographer</li>
          <li>Unlimited shots (soft copies)</li>
          <li>Same Day Edit Highlights (SDE)</li>
          <li>1 USB Drive with edited photos &amp; SDE video</li>
        </ul>
        <p class="pv-note">
          Perfect for intimate weddings that still want complete coverage of the ceremony and reception.
        </p>
      </article>
    </section>
    ...
    <section class="pv-package">
      <div class="pv-photo">
        <img src="pvwedding2.jpg" alt="EUPHORIA photo and video package sample">
      </div>
      <article class="pv-card">
        <div class="pv-title">EUPHORIA Package</div>
        <div class="pv-price">Php 25,000</div>
        <ul class="pv-list">
          <li>Full Photo Coverage (2 Photographers)</li>
          <li>2 Professional Videographers</li>
          <li>Preparation, Ceremony, and Reception coverage</li>
          <li>Same Day Edit (SDE) with AVP playback</li>
          <li>Highlight film (3–5 minutes)</li>
          <li>USB Drive with edited photos &amp; videos</li>
        </ul>
        <p class="pv-note">
          Best for mid-sized celebrations that want both a cinematic SDE and a highlight film to share online.
        </p>
      </article>
    </section>
    ...
    <section class="pv-package">
      <div class="pv-photo">
        <img src="pvwedding3.jpg" alt="BLISS photo and video package sample">
      </div>
      <article class="pv-card">
        <div class="pv-title">BLISS Package</div>
        <div class="pv-price">Php 30,000</div>
        <ul class="pv-list">
          <li>Full Photo Coverage (3 Photographers)</li>
          <li>2–3 Professional Videographers</li>
          <li>Complete wedding day coverage</li>
          <li>Same Day Edit (SDE) for reception</li>
          <li>Cinematic wedding film (8–10 minutes)</li>
          <li>Raw video files + edited photos on USB</li>
        </ul>
        <p class="pv-note">
          Ideal for grand weddings that want every angle captured, plus a full cinematic film and keepsake archive.
        </p>
      </article>
    </section>
  </div>
