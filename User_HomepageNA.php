<?php
// User_Homepage.php (guest/user-aware)
// Shows Book + Account if logged-in; shows only Register (same style) if not.
// Login check uses $_SESSION['user_id']; adjust as needed for your auth.

if (session_status() === PHP_SESSION_NONE) { session_start(); }
$has_account = !empty($_SESSION['user_id']);
?>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .right-actions{
      justify-self:end; width:var(--right-col, 260px);
    ...
    /* Open on hover/focus-within (no JS) */
    ...
    .hero-card img{ display:block; width:100%; height:420px; object-fit:cover }
    ...
    .section-cta .sub{ max-width:760px; margin:0 auto; color:#2c3e50; font-weight:700; letter-spacing:.5px }
    ...
    .feature-card img{ position:absolute; inset:0; width:100%; height:100%; object-fit:cover; filter:brightness(.78); }
...
<body>
  <header class="header">
    ...
    <div class="mast">
      ...
      <nav class="nav" aria-label="Primary">
        <a class="active" href="User_HomepageNA.php">Home</a>
    ...
    <!-- Right: Book + Account (or Register when no account) -->
    <div class="right-actions">
      ...
      <?php else: ?>
        <!-- Only Register (same color/size/weight as Book) -->
        <a class="toplink" href="Register.php">Register</a>
      <?php endif; ?>
    </div>
  </header>
  ...
  <main class="hero">
    <div class="hero-grid">
      <section>
        ...
        <p class="lead">Turning your dream<br/>celebrations into timeless<br/>memories.</p>
      </section>
    ...
    <section class="section-cta">
      <h3>LET US TAKE CARE OF EVERY DETAIL SO YOU CAN ENJOY A<br/>
      BEAUTIFULLY PLANNED, WORRY-FREE CELEBRATION.</h3>
      <p class="sub"></p>
    </section>

    <section class="section-desc">
      Turn your celebration into an unforgettable masterpiece with Everest’s Event Styling.
      Our talented team collaborates with you to craft a breathtaking atmosphere that perfectly captures your personality and vision.
    </section>
  </main>

  <!-- ===== Wedding / Debut cards + About Us ===== -->
  ...
  <section class="about" id="about">
    <h2>ABOUT US</h2>
    <div class="placeholder">Add your About Us text, photos, or stats here.</div>
  </section>
