<?php
// Directory_ElegantGown.php — Elegant Gown category page
...
<head>
  ...
  <title>Elegant Gown — Everest</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    #eg-hero{
      ...
      min-height:520px;
      position:relative;
      background:url('elegantgownBG.jpeg') center 55% / cover no-repeat;
    ...
    .eg-package{ width:100%; max-width:320px; }
    ...
    @media (max-width:980px){
      ...
      .eg-grid{grid-template-columns:1fr; justify-items:stretch}
      .eg-package{max-width:none}
      #eg-hero{height:260px}
    }
  </style>
</head>
<body>
...
<!-- HERO -->
<section id="eg-hero" aria-label="Elegant Gown hero">
  <h1 class="hero-title">ELEGANT GOWN</h1>
</section>

<main class="wrap">
  <p class="eg-intro">
    Walk down the aisle in a gown that matches your story. Choose from elegant rental and custom packages
    that include fitting, basic alterations, and styling support for your big day.
  </p>

  <div class="eg-grid">
    <!-- STARTER ELEGANCE PACKAGE -->
    <section class="eg-package">
      <div class="eg-photo">
        <img src="eg_starter.jpg" alt="Starter Elegance Gown Package sample">
      </div>
      <article class="eg-card">
        <div class="eg-title">Starter Elegance Package</div>
        <div class="eg-price">Php 15,000</div>
        <ul class="eg-list">
          <li>Off-the-rack wedding gown rental</li>
          <li>1 scheduled fitting session</li>
          <li>Basic size adjustments (length &amp; minor fit)</li>
          <li>Veil and simple hair accessory included</li>
        </ul>
        <p class="eg-note">
          Ideal for brides who want a beautiful gown on a practical budget.
        </p>
      </article>
    </section>
    ...
    <section class="eg-package">
      <div class="eg-photo">
        <img src="eg_classic.jpg" alt="Classic Bridal Gown Package sample">
      </div>
      <article class="eg-card">
        <div class="eg-title">Classic Bridal Package</div>
        <div class="eg-price">Php 25,000</div>
        <ul class="eg-list">
          <li>Premium gown rental with lace / bead details</li>
          <li>2–3 fitting sessions before the event</li>
          <li>Custom adjustments to fit and length</li>
          <li>Veil, gloves, and basic petticoat</li>
          <li>Steaming / pressing before pickup</li>
        </ul>
        <p class="eg-note">
          Best for brides who want a more detailed, figure-flattering gown with extra fittings.
        </p>
      </article>
    </section>
    ...
    <section class="eg-package">
      <div class="eg-photo">
        <img src="eg_signature.jpg" alt="Signature Couture Gown Package sample">
      </div>
      <article class="eg-card">
        <div class="eg-title">Signature Couture Package</div>
        <div class="eg-price">Php 40,000</div>
        <ul class="eg-list">
          <li>Semi-custom or bespoke-inspired gown design</li>
          <li>Multiple fitting sessions with designer consultation</li>
          <li>Detailed beadwork, lace, or appliqué options</li>
          <li>Full bridal set: gown, veil, petticoat, accessories</li>
          <li>Day-of assistance for gown dressing (optional add-on)</li>
        </ul>
        <p class="eg-note">
          Perfect for brides who want a standout couture look and a personalized fitting experience.
        </p>
      </article>
    </section>
  </div>
