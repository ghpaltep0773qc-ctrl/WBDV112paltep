<?php
// Directory_Souvenirs.php — Souvenirs category page
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    #sv-hero{
      ...
      min-height:520px;
      position:relative;
      background:url('souvenirsbg.jpg') center 55% / cover no-repeat;
    ...
    .sv-package{ width:100%; max-width:320px; }
    ...
    @media (max-width:980px){
      ...
      .sv-grid{grid-template-columns:1fr; justify-items:stretch}
      .sv-package{max-width:none}
      #sv-hero{height:260px}
    }
  </style>
</head>
<body>
...
<!-- HERO -->
<section id="sv-hero" aria-label="Souvenirs hero">
  <h1 class="hero-title">SOUVENIRS</h1>
</section>

<main class="wrap">
  <p class="sv-intro">
    Send your guests home with a piece of your story. Choose from curated souvenir sets that are
    thoughtful, practical, and photo-ready for your celebration tables.
  </p>

  <div class="sv-grid">
    <!-- TOKEN PACKAGE -->
    <section class="sv-package">
      <div class="sv-photo">
        <img src="sv_basic.jpg" alt="Token Souvenir Package sample">
      </div>
      <article class="sv-card">
        <div class="sv-title">TOKEN Package</div>
        <div class="sv-price">Php 8,000 (50 pcs)</div>
        <ul class="sv-list">
          <li>Personalized keychains or magnets</li>
          <li>Simple printed tag with couple’s names &amp; date</li>
          <li>Basic gift box or clear pouch</li>
          <li>Choice of 2 color themes</li>
        </ul>
        <p class="sv-note">
          Ideal for small weddings that want simple but personalized thank-you gifts.
        </p>
      </article>
    </section>

    <!-- CLASSIC KEEPSAKE PACKAGE -->
    <section class="sv-package">
      <div class="sv-photo">
        <img src="sv_classic.jpg" alt="Classic Souvenir Package sample">
      </div>
      <article class="sv-card">
        <div class="sv-title">CLASSIC Keepsake Package</div>
        <div class="sv-price">Php 15,000 (100 pcs)</div>
        <ul class="sv-list">
          <li>Mini candles, soaps, or mugs (pick one)</li>
          <li>Custom label design with motif colors</li>
          <li>Gift box with ribbon or twine</li>
          <li>Thank-you card inside each box</li>
        </ul>
        <p class="sv-note">
          Best for mid-sized receptions wanting coordinated souvenirs that match the event theme.
        </p>
      </article>
    </section>

    <!-- PREMIUM SIGNATURE PACKAGE -->
    <section class="sv-package">
      <div class="sv-photo">
        <img src="sv_premium.jpg" alt="Premium Souvenir Package sample">
      </div>
      <article class="sv-card">
        <div class="sv-title">PREMIUM Signature Package</div>
        <div class="sv-price">Php 28,000 (150 pcs)</div>
        <ul class="sv-list">
          <li>Custom tumblers, wooden coasters, or mini plants</li>
          <li>Full-color printed sleeve or tag</li>
          <li>Themed premium gift box</li>
          <li>Coordinated table display crates or trays</li>
        </ul>
        <p class="sv-note">
          Perfect for grand events where souvenirs double as décor and long-lasting keepsakes.
        </p>
      </article>
    </section>
  </div>
