<?php
// Directory_HairMakeup.php — Hair and Make-up category page
...
<head>
  ...
  <title>Hair and Make-up — Everest</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    #hm-hero{
      ...
      min-height:520px;
      position:relative;
      background:url('hairmakeupBG.jpg') center 55% / cover no-repeat;
      /* put your hero image here, e.g. hairmakeupBG.jpg */
    ...
    .hm-package{ width:100%; max-width:320px; }
    ...
    @media (max-width:980px){
      ...
      .hm-grid{grid-template-columns:1fr; justify-items:stretch}
      .hm-package{max-width:none}
      #hm-hero{height:260px}
    }
  </style>
</head>
<body>
...
<!-- HERO -->
<section id="hm-hero" aria-label="Hair and Make-up hero">
  <h1 class="hero-title">HAIR AND MAKE-UP</h1>
</section>

<main class="wrap">
  <p class="hm-intro">
    Look camera-ready from aisle to after-party. Our hair and make-up packages are designed to last through
    the ceremony, reception, and every photo in between.
  </p>

  <div class="hm-grid">
    <!-- FRESH GLOW PACKAGE -->
    <section class="hm-package">
      <div class="hm-photo">
        <img src="hm_fresh.jpg" alt="Fresh Glow Hair and Make-up Package sample">
      </div>
      <article class="hm-card">
        <div class="hm-title">FRESH GLOW Package</div>
        <div class="hm-price">Php 8,000</div>
        <ul class="hm-list">
          <li>Bridal make-up (natural / light glam)</li>
          <li>Simple updo or soft curls</li>
          <li>1 trial make-up session</li>
          <li>Basic retouch kit (lipstick &amp; blotting sheets)</li>
        </ul>
        <p class="hm-note">
          Perfect for brides who want a soft, natural look that still stands out in photos.
        </p>
      </article>
    </section>

    <!-- CLASSIC GLAM PACKAGE -->
    <section class="hm-package">
      <div class="hm-photo">
        <img src="hm_classic.jpg" alt="Classic Glam Hair and Make-up Package sample">
      </div>
      <article class="hm-card">
        <div class="hm-title">CLASSIC GLAM Package</div>
        <div class="hm-price">Php 12,000</div>
        <ul class="hm-list">
          <li>Bridal hair and make-up (medium to full glam)</li>
          <li>1 trial session with look planning</li>
          <li>2 additional faces (e.g. mother / maid of honor)</li>
          <li>On-the-day retouch before reception program</li>
        </ul>
        <p class="hm-note">
          Best for brides who want a more defined, photo-ready look and coverage for key family members.
        </p>
      </article>
    </section>

    <!-- RED CARPET LUXE PACKAGE -->
    <section class="hm-package">
      <div class="hm-photo">
        <img src="hm_luxe.jpg" alt="Red Carpet Luxe Hair and Make-up Package sample">
      </div>
      <article class="hm-card">
        <div class="hm-title">RED CARPET LUXE Package</div>
        <div class="hm-price">Php 18,000</div>
        <ul class="hm-list">
          <li>Full bridal glam with premium products</li>
          <li>2 trial looks (day &amp; night option)</li>
          <li>Up to 4 additional faces (entourage / family)</li>
          <li>On-site artist standby for retouch until program</li>
          <li>Hair accessories and lashes included</li>
        </ul>
        <p class="hm-note">
          Ideal for grand weddings and brides who want all-day support and red-carpet-level glam.
        </p>
      </article>
    </section>
  </div>
