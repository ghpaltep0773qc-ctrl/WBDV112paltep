<?php
// User_Homepage.php — base styling matches Directory.php
...
<head>
  ...
  <title>Everest — Wedding & Debut Event Planning</title>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    .header{
      ...
      background:linear-gradient(#fafcfe,#f1f5fb); border-bottom:1px solid #e6ecf7;
    }
    ...
    .nav a .caret{width:14px;height:14px;flex:0 0 14px;opacity:.85}
    ...
    .toplink, .toplink:link, .toplink:visited{
      ...
      color: var(--link) !important; font-size: 18px !important; font-weight: 700 !important; line-height:1; padding:0;
    }
    ...
    /* ===== Homepage sections ===== */
    .hero{ max-width:1120px;margin:24px auto 0;padding:8px 20px 40px; flex:1;width:100% }
    .hero-grid{ display:grid; grid-template-columns:1.1fr 1.4fr; gap:28px; align-items:center }
    .hero h2{ font-family:"Playfair Display",Georgia,serif; font-size:48px; line-height:1.1; margin:0 0 12px }
    .hero p.lead{ color:var(--muted); font-size:16px; line-height:1.8; max-width:560px }
    .hero-card{ border-radius:16px; overflow:hidden; box-shadow:0 10px 26px rgba(20,35,57,.10) }
    .hero-card img{ display:block; width:100%; height:420px; object-fit:cover; border:0; outline:none }

    .section-cta{ background:#fff; border-top:1px solid var(--border); border-bottom:1px solid var(--border); margin-top:32px; padding:36px 20px; text-align:center }
    .section-cta h3{ font-family:"Playfair Display",Georgia,serif; font-weight:700; margin:0 0 10px; font-size:18px; letter-spacing:.5px }
    .section-desc{ max-width:980px; margin:22px auto 40px; color:#49576a; text-align:center; line-height:1.8; font-size:15px }

    .showcase{ max-width:1120px;margin:0 auto;padding:16px 20px 24px; }
    .card-row{ display:grid; grid-template-columns:repeat(2,minmax(260px,1fr)); gap:28px; }
    .feature-card{ position:relative; border-radius:28px; overflow:hidden; aspect-ratio:16/9; background:#000; box-shadow:0 10px 24px rgba(0,0,0,.10); isolation:isolate; }
    .feature-card img{ position:absolute; inset:0; width:100%; height:100%; object-fit:cover; filter:brightness(.78); border:0; outline:none }
    .feature-card::after{ content:""; position:absolute; inset:0; background:linear-gradient(to bottom,rgba(0,0,0,0) 35%,rgba(0,0,0,.38)); }
    .feature-card h3{ position:absolute; left:24px; bottom:18px; margin:0; font-family:"Playfair Display",Georgia,serif; font-weight:700; font-size:44px; letter-spacing:.5px; color:#fff; text-shadow:0 2px 10px rgba(0,0,0,.35); }
    .feature-card a{ position:absolute; inset:0; z-index:2 }

    .about{ max-width:1120px; margin:8px auto 48px; padding:40px 20px 60px; text-align:center; background:linear-gradient(#ffffff,#eef5ff); border-radius:0; }
    .about h2{ font-family:"Playfair Display",Georgia,serif; font-size:48px; letter-spacing:2px; margin:0 0 18px; }
    .about .placeholder{ min-height:360px; border:1.5px dashed #cbd5e1; border-radius:16px; background:#fff; display:flex; align-items:center; justify-content:center; color:#64748b; font-size:15px; }
...
<body>
  <header class="header">
    ...
    <div class="mast">
      ...
      <nav class="nav" aria-label="Primary">
        <a class="active" href="User_Homepage.php">Home</a>
  ...
  <main class="hero">
    <div class="hero-grid">
      <section>
        <h2>Wedding &amp; Debut<br/>Event Planning</h2>
        <p class="lead">Turning your dream celebrations into timeless memories.</p>
      </section>

      <aside class="hero-card">
        <img src="holdinghands.png" alt="Bride and groom holding hands with scenic background"/>
      </aside>
    </div>

    <section class="section-cta">
      <h3>LET US TAKE CARE OF EVERY DETAIL SO YOU CAN ENJOY A BEAUTIFULLY PLANNED, WORRY-FREE CELEBRATION.</h3>
    </section>

    <section class="section-desc">
      Turn your celebration into an unforgettable masterpiece with Everest’s Event Styling.
      Our team crafts a breathtaking atmosphere that captures your personality and vision.
    </section>
  </main>
  ...
  <section class="showcase">
    <div class="card-row">
      <article class="feature-card">
        <img src="wedding.jpg" alt="Wedding bouquet with couple in background">
        <h3>Wedding</h3>
        <a href="#wedding" aria-label="Explore Wedding packages"></a>
      </article>

      <article class="feature-card">
        <img src="debut.jpg" alt="Debutante in gown with flowers">
        <h3>Debut</h3>
        <a href="#debut" aria-label="Explore Debut packages"></a>
      </article>
    </div>
  </section>
