<?php
// Directory.php — styled to match User_Homepage.php (same header/footer)
...
<head>
  ...
  <style>
    ...
    *{box-sizing:border-box}
    ...
    /* ===== Header (copied to match User_Homepage.php) ===== */
    .header{
    ...
    /* ===== Page hero + directory grid ===== */
    .page-hero{ max-width:1120px;margin:24px auto 0;padding:8px 20px 0 }
    .page-hero.directory h1{ font-family:"Playfair Display",Georgia,serif; font-size:48px; letter-spacing:2px; text-align:center; margin:8px 0 4px }
    .dir-intro{ color:#49576a; text-align:center; line-height:1.8; font-size:15px; max-width:960px; margin:8px auto 24px }

    .dir-wrap{ max-width:1120px; margin:0 auto; padding:8px 20px 40px }
    .dir-grid{ display:grid; grid-template-columns:repeat(3,1fr); gap:22px }
    @media (max-width:980px){ .header{grid-template-columns:1fr} .right-actions{justify-content:center; width:100%} .nav{gap:22px; flex-wrap:wrap; white-space:normal} .dir-grid{grid-template-columns:repeat(2,1fr)} }
    @media (max-width:620px){ .dir-grid{grid-template-columns:1fr} }

    .tile{ position:relative; isolation:isolate; border-radius:18px; overflow:hidden; min-height:190px; aspect-ratio:16/10; background:#cfd9ea; box-shadow:0 10px 18px rgba(16,24,40,.06); display:block }
    .tile::before{ content:""; position:absolute; inset:0; background:var(--img,linear-gradient(135deg,#cfd9ea,#e2e8f0)) center/cover no-repeat; z-index:0; transform:scale(1.02) }
    .tile::after{ content:""; position:absolute; inset:0; background:linear-gradient( to bottom, rgba(0,0,0,.00) 30%, rgba(0,0,0,.36) 90% ); z-index:1 }
    .tile:hover{ transform:translateY(-2px); transition:transform .25s ease }
    .tile-label{ position:absolute; z-index:2; inset:auto 16px 16px 16px; color:#fff; font-weight:800; font-size:34px; line-height:1.06; letter-spacing:.6px; text-shadow:0 4px 18px rgba(0,0,0,.35) }
...
<body>
  ...
  <!-- ===== DIRECTORY HERO ===== -->
  <section class="page-hero directory">
    <h1>DIRECTORY</h1>
    <p class="dir-intro">Let Everest’s Event management bring your dream celebration to life. Our creative team will design and execute a stunning ambiance that mirrors your love story and showcases your one-of-a-kind style.</p>
  </section>

  <!-- ===== DIRECTORY GRID ===== -->
  <section class="dir-wrap">
    <div class="dir-grid">
      <a class="tile" href="Directory_Venue.php" style="--img:url('venuepic.jpg');"><span class="tile-label">Venue</span></a>
      <a class="tile" href="directory_PhotosVideos.php" style="--img:url('photovid.jpg');"><span class="tile-label">Photos<br />&amp; Videos</span></a>
      <a class="tile" href="directory_EventStyling.php" style="--img:url('eventstyle.jpg');"><span class="tile-label">Event<br />Styling</span></a>
      <a class="tile" href="directory_Souvenirs.php" style="--img:url('souvenir.jpg');"><span class="tile-label">Souvenirs</span></a>
      <a class="tile" href="directory_ElegantGown.php" style="--img:url('gown.jpg');"><span class="tile-label">Elegant<br />Gown</span></a>
      <a class="tile" href="directory_HairMake-up.php" style="--img:url('makeup.jpg');"><span class="tile-label">Hair and<br />Make-up</span></a>
    </div>
  </section>
